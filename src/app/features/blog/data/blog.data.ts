...
export const BLOG_POSTS_DATA: BlogPost[] = [
  {
    slug: 'angular-change-detection-deep-dive',
    title: 'Deep Dive into Angular Change Detection',
    excerpt: 'Understanding how Angular detects changes, the difference between Default and OnPush strategies, and how Signals are reshaping reactivity in Angular 17+.',
    content: `
...
`,
  ...
  },
  {
    ...
    title: 'Essential RxJS Operators for Angular Developers',
    excerpt: 'A practical guide to the most useful RxJS operators in Angular: switchMap, mergeMap, concatMap, debounceTime, distinctUntilChanged, and more.',
    content: `
...
`,
    ...
    tags: ['RxJS', 'Angular', 'Reactive Programming', 'Operators'],
    readingTime: 10,
  },
  {
    slug: 'fix-cls-angularjs',
    title: 'How to Fix CLS Issues in AngularJS Applications',
    excerpt: 'Practical strategies for reducing Cumulative Layout Shift in legacy AngularJS apps without a full rewrite.',
    content: `
...
`,
    ...
    tags: ['AngularJS', 'CLS', 'Performance', 'Core Web Vitals', 'Legacy'],
    readingTime: 7,
  },
  {
    slug: 'angular-universal-seo-guide',
    title: 'Complete Angular Universal SSR & SEO Guide',
    excerpt: 'How to implement Server-Side Rendering in Angular 17+ for maximum SEO impact, including meta tags, structured data, and prerendering strategies.',
    content: `
...
`,
    ...
    tags: ['Angular', 'SSR', 'SEO', 'Angular Universal', 'Prerendering'],
    readingTime: 9,
  }
];
